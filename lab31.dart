...
// Creating named and paramaterized Constructor with one parameter
  Gfg.constructor1(int a){
    print('This is the parameterized constructor with only one parameter');
  }
  
  //Creating named and prameterized Constructor with two parameter
...
void main() {
  ...
  Gfg geek1 = new Gfg.constructor1(1); // One parameter Called
  Gfg geek2 = new Gfg.constructor2(2, 3); // Two parameter Called
}
